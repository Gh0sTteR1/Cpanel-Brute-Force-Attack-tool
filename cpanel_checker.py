...
# © 2024 Amer Mohammad (Ghoster). All rights reserved.
...
print("  \n\n                      {}CPANEL-WHM-checker\n                      \n              {}your list should save with encoding:Utf-8\n    {}if u don't how how to save just copy your list into list.txt\n                     \n                    Programmed by the Ghoster\n           ".format(fg, fg, fg, fr, fg))
print ("I am innocent before God of any person who uses this tool to harm others.")
def check(txt):
    url = txt.split('|')[0]
    login = txt.split('|')[1]
